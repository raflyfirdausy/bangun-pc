...
public class Activity_amd_mb_am3 extends AppCompatActivity {
    ...
    private String URL_API = BASE_URL + "api/product/kondisi/id/19";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Activity_amd_mb_am3.this.setTitle("Pilih Motherboard Socket AM3");
    ...
    private void ambil_dataOnline() {
        jsonArrayRequest = new JsonArrayRequest(URL_API, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                recyclerViewAdapter adapter = new recyclerViewAdapter(Activity_amd_mb_am3.this, list);
                rv_konten.setLayoutManager(new LinearLayoutManager(Activity_amd_mb_am3.this));
                rv_konten.setAdapter(adapter);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Activity_amd_mb_am3.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });

        requestQueue = Volley.newRequestQueue(Activity_amd_mb_am3.this);
    ...
    public void pdlanjut(View v) {
        ...
        Intent i = new Intent(Activity_amd_mb_am3.this, Main2Activity.class); //MainActivity adalah aktivity awal ,praktikum1Activity activity yang akan di tuju
        startActivity(i);
        finish();
    }
