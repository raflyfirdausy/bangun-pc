...
public class Activity_intel_mb_lga1151 extends AppCompatActivity {
    ...
    private String URL_API = BASE_URL + "api/product/kondisi/id/17";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Activity_intel_mb_lga1151.this.setTitle("Pilih Motherboard Socket LGA 1151");
    ...
    private void ambil_dataOnline() {
        jsonArrayRequest = new JsonArrayRequest(URL_API, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                recyclerViewAdapter adapter = new recyclerViewAdapter(Activity_intel_mb_lga1151.this, list);
                rv_konten.setLayoutManager(new LinearLayoutManager(Activity_intel_mb_lga1151.this));
                rv_konten.setAdapter(adapter);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Activity_intel_mb_lga1151.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });

        requestQueue = Volley.newRequestQueue(Activity_intel_mb_lga1151.this);
    ...
    public void pdlanjut(View v) {
        ...
        Intent i = new Intent(Activity_intel_mb_lga1151.this, Activity_ddr4.class); //MainActivity adalah aktivity awal ,praktikum1Activity activity yang akan di tuju
        startActivity(i);
        finish();
    }
