...
public class Activity_vga extends AppCompatActivity {
    ...
    private String URL_API = BASE_URL + "api/product/kondisi/id/23";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Activity_vga.this.setTitle("Pilih VGA Card");
    ...
    private void ambil_dataOnline() {
        jsonArrayRequest = new JsonArrayRequest(URL_API, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                recyclerViewAdapter adapter = new recyclerViewAdapter(Activity_vga.this, list);
                rv_konten.setLayoutManager(new LinearLayoutManager(Activity_vga.this));
                rv_konten.setAdapter(adapter);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Activity_vga.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });

        requestQueue = Volley.newRequestQueue(Activity_vga.this);
...
//            Intent i = new Intent(Activity_vga.this, Activity_psu.class); //MainActivity adalah aktivity awal ,praktikum1Activity activity yang akan di tuju
//            startActivity(i);
//
//            finish();
//        } else {
