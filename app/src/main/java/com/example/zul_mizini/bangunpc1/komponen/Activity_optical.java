...
public class Activity_optical extends AppCompatActivity {
    ...
    private String URL_API = BASE_URL + "api/product/kondisi/id/28";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Activity_optical.this.setTitle("Pilih Optical Drive");
    ...
    private void ambil_dataOnline() {
        jsonArrayRequest = new JsonArrayRequest(URL_API, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                recyclerViewAdapter adapter = new recyclerViewAdapter(Activity_optical.this, list);
                rv_konten.setLayoutManager(new LinearLayoutManager(Activity_optical.this));
                rv_konten.setAdapter(adapter);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Activity_optical.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });

        requestQueue = Volley.newRequestQueue(Activity_optical.this);
...
//            Intent i = new Intent(Activity_optical.this, Activity_vga.class); //MainActivity adalah aktivity awal ,praktikum1Activity activity yang akan di tuju
//            startActivity(i);
//
//            finish();
//        } else {
