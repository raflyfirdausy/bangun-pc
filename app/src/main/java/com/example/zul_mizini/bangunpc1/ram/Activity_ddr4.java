package com.example.zul_mizini.bangunpc1.ram;
...
public class Activity_ddr4 extends AppCompatActivity {
    ...
    private String URL_API = BASE_URL + "api/product/kondisi/id/3";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Activity_ddr4.this.setTitle("Pilih RAM DDR4");
    ...
    private void ambil_dataOnline() {
        jsonArrayRequest = new JsonArrayRequest(URL_API, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                recyclerViewAdapter adapter = new recyclerViewAdapter(Activity_ddr4.this, list);
                rv_konten.setLayoutManager(new LinearLayoutManager(Activity_ddr4.this));
                rv_konten.setAdapter(adapter);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Activity_ddr4.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });

        requestQueue = Volley.newRequestQueue(Activity_ddr4.this);
...
//            Intent i = new Intent(Activity_ddr4.this, Activity_hddssd.class); //MainActivity adalah aktivity awal ,praktikum1Activity activity yang akan di tuju
//            startActivity(i);
//
//            finish();
//        } else {
