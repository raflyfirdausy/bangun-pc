...
public class Activity_amd_mb_tr4 extends AppCompatActivity {
    ...
    private String URL_API = BASE_URL + "api/product/kondisi/id/21";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Activity_amd_mb_tr4.this.setTitle("Pilih Motherboard Socket TR4");
    ...
    private void ambil_dataOnline() {
        jsonArrayRequest = new JsonArrayRequest(URL_API, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                recyclerViewAdapter adapter = new recyclerViewAdapter(Activity_amd_mb_tr4.this, list);
                rv_konten.setLayoutManager(new LinearLayoutManager(Activity_amd_mb_tr4.this));
                rv_konten.setAdapter(adapter);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Activity_amd_mb_tr4.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });

        requestQueue = Volley.newRequestQueue(Activity_amd_mb_tr4.this);
    ...
    public void pdlanjut(View v) {
        ...
        if (tv_harga.getText().toString().matches("0")) {
            Intent i = new Intent(Activity_amd_mb_tr4.this, Activity_ddr4.class); //MainActivity adalah aktivity awal ,praktikum1Activity activity yang akan di tuju
            startActivity(i);
            ...
            DetailBarangPilih.gambarbarangSementara = null;
