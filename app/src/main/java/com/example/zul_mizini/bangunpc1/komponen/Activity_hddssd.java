...
public class Activity_hddssd extends AppCompatActivity {
    ...
    private String URL_API = BASE_URL + "api/product/kondisi/id/22";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Activity_hddssd.this.setTitle("Pilih Harddisk / SSD");
    ...
    private void ambil_dataOnline() {
        jsonArrayRequest = new JsonArrayRequest(URL_API, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                recyclerViewAdapter adapter = new recyclerViewAdapter(Activity_hddssd.this, list);
                rv_konten.setLayoutManager(new LinearLayoutManager(Activity_hddssd.this));
                rv_konten.setAdapter(adapter);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Activity_hddssd.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });

        requestQueue = Volley.newRequestQueue(Activity_hddssd.this);
...
//            Intent i = new Intent(Activity_hddssd.this, Activity_cpucooler.class); //MainActivity adalah aktivity awal ,praktikum1Activity activity yang akan di tuju
//            startActivity(i);
//
//            finish();
//        } else {
