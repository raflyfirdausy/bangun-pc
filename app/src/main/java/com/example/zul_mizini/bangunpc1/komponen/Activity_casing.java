package com.example.zul_mizini.bangunpc1.komponen;
...
import com.example.zul_mizini.bangunpc1.HasilActivity;
import com.example.zul_mizini.bangunpc1.MainActivity;
...
public class Activity_casing extends AppCompatActivity {
    ...
    private String URL_API = BASE_URL + "api/product/kondisi/id/24";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Activity_casing.this.setTitle("Pilih Casing");
    ...
    private void ambil_dataOnline() {
        jsonArrayRequest = new JsonArrayRequest(URL_API, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                recyclerViewAdapter adapter = new recyclerViewAdapter(Activity_casing.this, list);
                rv_konten.setLayoutManager(new LinearLayoutManager(Activity_casing.this));
                rv_konten.setAdapter(adapter);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Activity_casing.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });

        requestQueue = Volley.newRequestQueue(Activity_casing.this);
...
//
//        if (tv_harga.getText().toString().matches("0")) {
//            Intent i = new Intent(Activity_casing.this, HasilActivity.class); //MainActivity adalah aktivity awal ,praktikum1Activity activity yang akan di tuju
//            startActivity(i);
//
//            finish();
//        } else {
...
//            if (tv_harga.getText().toString().matches("0")) {
//                try {
//                    UpdateHarga = DetailBarangPilih.totalHarga;
//                    tv_harga.setText("Rp " + UpdateHarga);
//                } catch (Exception e) {
//                    Log.d("Exeption", e.getMessage());
//                }
