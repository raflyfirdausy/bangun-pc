...
public class Activity_fan extends AppCompatActivity {
    ...
    private String URL_API = BASE_URL + "api/product/kondisi/id/27";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Activity_fan.this.setTitle("Pilih Fan");
    ...
    private void ambil_dataOnline() {
        jsonArrayRequest = new JsonArrayRequest(URL_API, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                recyclerViewAdapter adapter = new recyclerViewAdapter(Activity_fan.this, list);
                rv_konten.setLayoutManager(new LinearLayoutManager(Activity_fan.this));
                rv_konten.setAdapter(adapter);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Activity_fan.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });

        requestQueue = Volley.newRequestQueue(Activity_fan.this);
...
//            Intent i = new Intent(Activity_fan.this, Activity_optical.class); //MainActivity adalah aktivity awal ,praktikum1Activity activity yang akan di tuju
//            startActivity(i);
//
//            finish();
//        } else {
