...
public class Activity_cpucooler extends AppCompatActivity {
    ...
    private String URL_API = BASE_URL + "api/product/kondisi/id/26";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Activity_cpucooler.this.setTitle("Pilih CPU Cooler");
    ...
    private void ambil_dataOnline() {
        jsonArrayRequest = new JsonArrayRequest(URL_API, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                recyclerViewAdapter adapter = new recyclerViewAdapter(Activity_cpucooler.this, list);
                rv_konten.setLayoutManager(new LinearLayoutManager(Activity_cpucooler.this));
                rv_konten.setAdapter(adapter);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Activity_cpucooler.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });

        requestQueue = Volley.newRequestQueue(Activity_cpucooler.this);
...
//            Intent i = new Intent(Activity_cpucooler.this, Activity_fan.class); //MainActivity adalah aktivity awal ,praktikum1Activity activity yang akan di tuju
//            startActivity(i);
//
//            finish();
//        } else {
