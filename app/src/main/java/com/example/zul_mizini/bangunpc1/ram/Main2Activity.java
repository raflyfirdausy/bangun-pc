...
public class Main2Activity extends AppCompatActivity {
    ...
    private String URL_API = BASE_URL + "api/product/kondisi/id/2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Main2Activity.this.setTitle("Pilih RAM DDR3");
        ...
        jsonArrayRequest = new JsonArrayRequest(URL_API, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                for (int i = 0; i < response.length(); i++) {
                    ...
                    rv_konten.setLayoutManager(new LinearLayoutManager(Main2Activity.this));
...
//            Intent i = new Intent(Main2Activity.this, Activity_hddssd.class); //MainActivity adalah aktivity awal ,praktikum1Activity activity yang akan di tuju
//            startActivity(i);
//
//            finish();
//        } else {
