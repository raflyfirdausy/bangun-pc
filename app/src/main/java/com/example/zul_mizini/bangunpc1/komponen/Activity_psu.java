...
public class Activity_psu extends AppCompatActivity {
    ...
    private String URL_API = BASE_URL + "api/product/kondisi/id/25";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Activity_psu.this.setTitle("Pilih Power Supply");
    ...
    private void ambil_dataOnline() {
        jsonArrayRequest = new JsonArrayRequest(URL_API, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                recyclerViewAdapter adapter = new recyclerViewAdapter(Activity_psu.this, list);
                rv_konten.setLayoutManager(new LinearLayoutManager(Activity_psu.this));
                rv_konten.setAdapter(adapter);
            }
        }, new Response.ErrorListener() {
            @Override
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Activity_psu.this, error.getMessage(), Toast.LENGTH_LONG).show();
            }
        });

        requestQueue = Volley.newRequestQueue(Activity_psu.this);
...
//            Intent i = new Intent(Activity_psu.this, Activity_casing.class); //MainActivity adalah aktivity awal ,praktikum1Activity activity yang akan di tuju
//            startActivity(i);
//
//            finish();
//        } else {
