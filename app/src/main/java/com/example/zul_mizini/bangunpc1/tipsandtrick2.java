...
public class tipsandtrick2 extends AppCompatActivity {

    private String TAG = tipsandtrick2.class.getSimpleName();

    private ProgressDialog pDialog;
    private ListView lv;

    // URL to get contacts JSON
    private static String url = "https://raw.githubusercontent.com/zulkifli-mizini/kelompok2/master/tipstirik.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tipsandtrick2.this.setTitle("Tips dan Trik");
    ...
    private class Gettnt extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(tipsandtrick2.this);
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            if (jsonStr != null) {
                try {
                    ...
                    JSONArray tnts = jsonObj.getJSONArray("tipstrik");
